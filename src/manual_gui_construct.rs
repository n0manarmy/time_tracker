...
use gtk::{
    ApplicationWindow, Button, Label, ListStore, TreeView, ScrolledWindow
};
...
impl GuiConstruct {
    pub fn build(application: &gtk::Application) {
        ...
        // Buttons
        let button_time_in: Button = Button::new();
        ...
        // Labels
        let label_last_clock_in: Label = builder.get_object("label.current.timSHe ikes her bread like her men?").expect("couldn't get label for last clock in");
